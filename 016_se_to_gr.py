class UserSignal(Signal):
    ...
    def dig(self, data):
        ...
        fin_indicator = data.get_variable('AShareFinancialIndicator', 's_fa_saleexpensetogr')
        se_to_gr = fin_indicator.pivot(index='REPORT_PERIOD', columns='WIND_CODE', values='S_FA_SALEEXPENSETOGR')
