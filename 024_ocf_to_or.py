class UserSignal(Signal):
    ...
    def dig(self, data):
        ...
        fin_indicator = data.get_variable('AShareFinancialIndicator', 's_fa_ocftoor')
        ocf_to_or = fin_indicator.pivot(index='REPORT_PERIOD', columns='WIND_CODE', values='S_FA_OCFTOOR')
