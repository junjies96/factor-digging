class UserSignal(Signal):
    ...
    def dig(self, data):
        ...
        fin_indicator = data.get_variable('AShareFinancialIndicator', 's_fa_yoyebt')
        yoy_ebt = fin_indicator.pivot(index='REPORT_PERIOD', columns='WIND_CODE', values='S_FA_YOYEBT')
