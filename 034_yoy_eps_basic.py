class UserSignal(Signal):
    ...
    def dig(self, data):
        ...
        fin_indicator = data.get_variable('AShareFinancialIndicator', 's_fa_yoyeps_basic')
        yoy_eps_basic = fin_indicator.pivot(index='REPORT_PERIOD', columns='WIND_CODE', values='S_FA_YOYEPS_BASIC')
